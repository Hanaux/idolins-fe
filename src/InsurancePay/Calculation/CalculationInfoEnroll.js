...
function CalcluationInfoEnroll ({accNum, decisionCompensationProperty, decisionCompensationHuman}) {
    ...
    return <div>산출정보 등록이 완료되었습니다.<br/>추가 등록을 원하시면 초기화 버튼을 눌러주세요</div>
}

export default CalcluationInfoEnroll;